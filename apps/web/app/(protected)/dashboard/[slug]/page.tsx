    ...
    <div className="min-h-screen  text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-8 gap-4">
          <div className="flex items-center space-x-4 flex-1 min-w-0">
            ...
            <div className="flex gap-4 min-w-0">
              <input
                className="text-xl lg:text-2xl font-bold bg-transparent border border-white/25 rounded-lg p-2 outline-none max-w-xs w-1/2"
        ...
        <div className="flex justify-center mt-12">
          <div className="space-y-8 max-w-6xl min-w-[75%] w-full">
            {/* Triggers */}
            <div className="bg-white/5 rounded-lg p-6 border border-white/10 max-w-5xl mx-auto">
              ...
              {automation.trigger.length > 0 ? (
                <div className="space-y-4">
                  {automation.trigger.map((trigger) => (
                    <div
                      key={trigger.id}
                      className="p-4 flex gap-24 bg-white/10 border border-white/20 rounded-lg"
                    >
                      <div className=" mb-3">
                          ...
                          <div className="p-4 space-y-4">
                            ...
                            {listenerOptions.map((option) => (
                              <div
                                ...
                                onClick={() =>
                                  setSelectedListenerType(option.id)
                                }
                              >
            ...
            <div className="bg-white/5 rounded-lg p-6 border border-white/10 max-w-5xl mx-auto">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-semibold">Listeners</h3>
              </div>
              {automation.listener.length > 0 ? (
                <div className="space-y-4">
                  {automation.listener.map((listener) => (
                    ...
                    >
                      ...
                      <div className=" flex mt-5 mb-5 gap-24">
